...
- If the actual Cursor run fails with Keychain/profile errors, use the launcher's log and generated `native-command.sh` as a repro path from Terminal, iTerm, or an attached OMX/OMC tmux shell.
