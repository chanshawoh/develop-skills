...
usage() {
  cat <<'EOF'
Usage:
  cursor-agent-run.sh --repo /path/to/repo --task task-id --prompt-file /tmp/task.cursor.prompt.md [--fresh] [--model model] [--mode ask|plan] [--no-approve-mcps] [--worktree name]
